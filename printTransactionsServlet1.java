...
public class printTransactionsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>\r\n" + 
				...
				"<pre>from date:  <input type=\"date\" name=\"from_date\" size=\"20\">  to date:  <input type=\"date\" name=\"to_date\" size=\"20\"><br>  \r\n" + 
				...
				for(Transaction transaction:transactions) {
							...
							out.println("<td>"+transaction.getFromAccount()+"</td>");
							out.println("<td>"+transaction.getToAccount()+"</td>");
